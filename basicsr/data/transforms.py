...
def paired_random_crop(img_gts, img_lqs, lq_patch_size, scale, lq_path, gt_path):
    """Paired random crop.
...
def paired_random_crop_tri(img_gts, img_lqs, img_refs, lq_patch_size, scale, lq_path, gt_path):
    ...
    return img_gts, img_lqs, img_refs
...
# Dehazeformer
def dehazeformer_augment(imgs=[], size=256, edge_decay=0., only_h_flip=False):
    H, W, _ = imgs[0].shape
    Hc, Wc = [size, size]

...
class Visualizer():
    ...
    @write_until_success
    def print_Acc(self, epoch, total_epoch, time_val, acc):
        self.writer.add_scalar('val/Accuracy', acc, epoch)
        print('End of epoch %d / %d (Val) \t Time Taken: %.3f s \t Accuracy:%.2f'
                % (epoch, total_epoch, time_val, acc))
